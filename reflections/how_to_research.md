...
I gave my project flowchart to gpt
https://bitbucket.org/vileider/year3/src/main/images/12_02_2024_design_chart.png

And as a response I get that it is clear object-oriented approach to software design. AI noticed a well-thought-out architecture with separation of concerns and a good use of design patterns. 
https://bitbucket.org/vileider/year3/src/main/images/GPT_suggested_user_stories.png
Gpt also created user stories that I can use during the plannign session

All above confirms that that using AI can increase the speed of project flow, Hoivewer I am aware of possible mistake so I stil need to be carefull and mointor AI output.
#
I was researching every time I got stuck or wanted to expand my knowledge. I could give many examples from the past, but I'll start with what I'm currently working on.
